              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="post" action="<?= base_url() . 'department/add'; ?>" enctype='multipart/form-data'>
                      <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Task Stage Name</label>
                        <input type="text" class="form-control" value="" required name="department_name">
                      </div>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalMessageTitle" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form id="editForm" method="post" action="<?= base_url() . 'department/update'; ?>" enctype='multipart/form-data'>
                      <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Task Stage Name</label>
                        <input type="text" class="form-control" value="" required name="department_name_e">
                      </div>
                    ...
                    <tr>
                        ...
                        <div class="d-flex px-2">
                          <div class="my-auto">
                            <a href="tables_tasks.html">
                              <h6 class="mb-0 text-sm"><span class="badge bg-gradient-dark">#<?= $record->department_id; ?></span></h6>
                            </a>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2">
                          <div class="my-auto">
                            <a href="tables_tasks.html">
                              <h6 class="mb-0 text-sm"><?= $record->department_name; ?></h6>
                            </a>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <p class="text-sm font-weight-bold mb-0 momentDate"><?= $record->department_created_at; ?></p>
                      </td>
                      ...
                      <td class="align-middle">
                        ...
                        <div class="d-flex px-2">
                          <div class="my-auto">
                            <a href="<?= base_url() . 'department/delete/' . $record->department_id; ?>">
                              <i class="fas fa-trash" aria-hidden="true"></i></span>
                            </a>

                            <a href="#" onclick="edit('<?= $record->department_id; ?>')">
...
<script>
  ...
  function edit(id = 1) {
    ...
    $.ajax({
        method: "GET",
        url: `${baseUrl}department/get_record/${id}`,
      })
      .done(function(data) {
        data = JSON.parse(data);
        $("input[name='department_name_e']").val(data.data.department_name);
        $('#editModal').modal('show');



        $('#editForm').attr('action', `${baseUrl}department/update/${data.data.department_id}`);
